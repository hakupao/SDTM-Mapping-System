...
# STUDY_ID = 'GOZILA'
# CODELIST_TABLE_NAME = 'VC02_GOZILA_CODELIST'
# METADATA_TABLE_NAME = 'VC02_GOZILA_METADATA'
# TRANSDATA_VIEW_NAME = 'VC02_GOZILA_TRANSDATA'
# M5_PROJECT_NAME = ['GOZILA Study (NO.0001-1500)','GOZILA Study (NO.1501-3000)','GOZILA Study (NO.3001-)']

# STUDY_ID = 'MONSTAR2'
# CODELIST_TABLE_NAME = 'VC05_MONSTAR2_CODELIST'
# METADATA_TABLE_NAME = 'VC05_MONSTAR2_METADATA'
# TRANSDATA_VIEW_NAME = 'VC05_MONSTAR2_TRANSDATA'
# M5_PROJECT_NAME = ''
# RAW_DATA_ROOT_PATH = r'C:\Users\張俊傑\OneDrive - iTMS株式会社\ドキュメント - DXユニット開発チーム\EDC\統合DB\02_VAPORCONE\50_MONSTAR2\01_RawData'
...
M5_PROJECT_NAME = ''
RAW_DATA_ROOT_PATH = r'D:\iTMS\iTMS株式会社\DXユニット開発チーム - 文档\EDC\統合DB\99_個人フォルダ\張(泊)\60_CIRCULATE\Raw Data\データセット\20241205_CSV'
...
# FOLDER_RAWDATA = '01_RawData'
# RAW_DATA_ROOT_PATH = os.path.join(SPECIFIC_PATH, FOLDER_RAWDATA)
...
STANDARD_FIELDS = {
    ...
    # 'SV':['STUDYID','DOMAIN','USUBJID','VISITNUM','VISIT','SVPRESP','SVOCCUR','SVREASOC','SVCNTMOD','SVEPCHGI','VISITDY','SVSTDTC','SVENDTC','SVSTDY','SVENDY','SVUPDES'],
    # 'TA':['STUDYID','DOMAIN','ARMCD','ARM','TAETORD','ETCD','ELEMENT','TABRANCH','TATRANS','EPOCH'],
    # 'TD':['STUDYID','DOMAIN','TDORDER','TDANCVAR','TDSTOFF','TDTGTPAI','TDMINPAI','TDMAXPAI','TDNUMRPT'],
    ...
    # 'TV':['STUDYID','DOMAIN','VISITNUM','VISIT','VISITDY','ARMCD','ARM','TVSTRL','TVENRL'],
    # 'OI':['STUDYID','DOMAIN','NHOID','OISEQ','OIPARMCD','OIPARM','OIVAL'],
    # 'GA':['STUDYID','DOMAIN','USUBJID','SPDEVID','GASEQ','GAREFID','GADTC','GASPEC','VARTYP','GASYM','SVTRSC','SVPRTCHG','SVCDSCHG','SVGENLOC','SVCVRG','SVFUNEFF','CNACPYNUM','CNAEXON','CNATYP','CNAGENLOC','RARSYM1','RARSYM2','RARDTL','RARGENLOC1','RARGENLOC2','MSISTAT','MSIRES','TMBRES'],
    # 'SREF':['STUDYID','DOMAIN','USUBJID','SUBJID','VISITNUM','VISIT','GRPID','SEQ','RDSNAM','RDNAM','RDLBL','RDVAL','RDCDVAL']
}
